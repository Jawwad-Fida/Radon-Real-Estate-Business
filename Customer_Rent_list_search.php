    ...
    <div id="wrapper">
        ...
        <section class="properties-list full featured portfolio blog">
            <div class="container">
                ...
                <!-- Search Form -->
                <form action="Customer_Rent_list_search.php" method="post" id="test3"class="search">   
                            ...
                            <div class="tab-pane fade show active" id="tabs_1">
                                <div class="rld-main-search">
                                    <div class="row">
                                        ...
                                        <button class="btn btn-yellow" form="test3" name="search" type ="submit" formmethod="post">Search Now</button>
                                        </div>
