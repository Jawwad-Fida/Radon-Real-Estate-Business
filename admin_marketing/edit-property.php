...
if (isset($_GET['edit'])) {
    ...
    $stmt = query("SELECT * FROM building WHERE building_id ={$building_id}");
...
if (isset($_POST['update_submit'])) {
    ...
    redirect("view-property.php?success=item_update");
}
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <p>
                                                ...
                                                <input type="text" name="name" id="title" value="<?php echo $building_name; ?>">
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row">
