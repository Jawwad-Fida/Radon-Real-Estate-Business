...
if (isset($_GET['delete'])) {
    ...
    redirect("view-Rent-apartment.php?success=item_delete");
}
?>
                    ...
                    <div class="col-lg-9 col-md-12 col-xs-12 royal-add-property-area section_100 pl-0 user-dash2">
                        ...
                        <div class="dashborad-box stat bg-white">
                            ...
                            <div class="dashborad-box">
                                <h4 class="title">View Apartment Information - For Rent</h4>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped">
                                            ...
                                            <tbody>
                                                ...
                                                $stmt = query("SELECT * FROM apartment WHERE (apartment_status='Rent' AND status='Not Booked')");
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="edit"><a onClick="javascript: return confirm('Do want to delete this item?');" href="view-Rent-apartment.php?delete=<?php echo $apartment_id; ?>"><i class="fa fa-trash"></i></a></td>
                                                    </tr>
