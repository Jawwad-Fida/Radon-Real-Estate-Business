...
if (isset($_GET['delete'])) {
    ...
    $stmt = query("DELETE FROM building WHERE building_id={$building_id}");
    redirect("view-property.php?success=item_delete");
}
?>
                    ...
                    <div class="col-lg-9 col-md-12 col-xs-12 royal-add-property-area section_100 pl-0 user-dash2">
                        ...
                        <div class="dashborad-box stat bg-white">
                            ...
                            <div class="dashborad-box">
                                <h4 class="title">View Property Information</h4>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="edit"><a href="edit-property.php?edit=<?php echo $building_id; ?>"><i class="fa fa-pencil"></i></a></td>
                                                        <td class="edit"><a onClick="javascript: return confirm('Do want to delete this item?');" href="view-property.php?delete=<?php echo $building_id; ?>"><i class="fa fa-trash"></i></a></td>
                                                    </tr>
