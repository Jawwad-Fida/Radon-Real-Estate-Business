                    ...
                    <div class="col-lg-9 col-md-12 col-xs-12 royal-add-property-area section_100 pl-0 user-dash2">
                        ...
                        <div class="dashborad-box stat bg-white">
                            ...
                            <div class="dashborad-box">
                                <h4 class="title">View Customer Information</h4>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $age; ?></td>
                                                        <td class="edit"><a onClick="javascript: return confirm('Authorize to Client?');" href="client_authorize.php?edit=<?php echo $customer_id; ?>&user_id=<?php echo $user_id; ?>"><i class="fa fa-check"></i></a></td>
                                                    </tr>
